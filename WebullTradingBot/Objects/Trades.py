...
class Trade():
    ...
    def __init__(self):
        ...
        self._webull_client: object = None
    ...
    def grab_price(self) -> float:
        ...
        if self.order_type == 'mkt':
            ...
            quote = self._webull_client.get_quotes(instruments = [self.symbol])
    ...
    def _update_order_status(self) -> None:
        """Updates the current order status, to reflect what's on webull."""        

        if self.order_id != "":

            order_response = self._webull_client.get_orders(
    ...
    def check_status(self) -> object:
        ...
        from Objects.OrderStatus import OrderStatus
